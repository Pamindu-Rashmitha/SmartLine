...
const ApplyLoanPage = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-4 px-2 space-y-6">
      ...
      {/* Stepper Progress */}
      <Card className="bg-slate-900/60 border-slate-800 shadow-lg rounded-2xl">
        <Steps
          current={currentStep}
      ...
      <div className="min-h-[480px]">
        ...
        {currentStep === 0 && (
          <div className="space-y-6">
            <h3 className="text-lg font-semibold text-slate-200 text-center">Select Your Financing Facility</h3>
            <Row gutter={[24, 24]}>
              <Col xs={24} md={12}>
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-2xl border-2 transition-all duration-300 relative overflow-hidden flex flex-col justify-between h-full ${
                    facilityType === 'LOAN'
                      ? 'bg-blue-950/30 border-blue-500 shadow-2xl shadow-blue-600/20'
                ...
                >
                  ...
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-blue-600/20 text-blue-400 flex items-center justify-center mb-4">
                      <Wallet className="w-7 h-7" />
                    </div>
                    <h4 className="text-xl font-bold text-white mb-2">Money Loan Facility</h4>
                    ...
                    <div className="mt-4 space-y-2 text-xs text-slate-300">
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Financing up to LKR 3,000,000
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Flexible tenure from 12 to 60 months
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Attractive flat rate from 14.5% p.a.
                      </div>
                    </div>
                  </div>
                  <div className="mt-6 pt-4 border-t border-slate-800 flex justify-between items-center">
                    <span className="text-xs text-slate-400">Processing: 24-48 Hours</span>
                ...
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-2xl border-2 transition-all duration-300 relative overflow-hidden flex flex-col justify-between h-full ${
                    facilityType === 'VEHICLE_LEASE'
                      ? 'bg-indigo-950/30 border-indigo-500 shadow-2xl shadow-indigo-600/20'
                      : 'bg-slate-900/60 border-slate-800 hover:border-slate-700'
                  }`}
                >
                  {facilityType === 'VEHICLE_LEASE' && (
                  ...
                  <div>
                    ...
                    <h4 className="text-xl font-bold text-white mb-2">Vehicle Leasing Facility</h4>
                    <p className="text-sm text-slate-400 leading-relaxed">
                    ...
                    <div className="mt-4 space-y-2 text-xs text-slate-300">
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Financing up to 80% of vehicle value
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Flexible tenure up to 72 months
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-emerald-400" /> Fast-track field valuation approval
                      </div>
                    </div>
                  </div>
                  <div className="mt-6 pt-4 border-t border-slate-800 flex justify-between items-center">
                    <span className="text-xs text-slate-400">Processing: 24-72 Hours</span>
                ...
                {facilityType === 'LOAN' ? (
                  <Row gutter={16}>
                    <Col xs={24} md={12}>
                      <Form.Item
                        name="purpose"
                        label={<span className="text-slate-300">Loan Purpose</span>}
                    ...
                    <Col xs={24} md={12}>
                      <Form.Item
                        ...
                        label={<span className="text-slate-300">Total Existing Loans / Credit Card Debts (LKR)</span>}
                      >
                        <InputNumber
                          className="w-full"
                          min={0}
                    ...
                    <Col xs={24}>
                      <Form.Item name="existingLoans" label={<span className="text-slate-300">Existing Bank / Finance Institution Details</span>}>
                  ...
                  <Row gutter={16}>
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item
                        ...
                        label={<span className="text-slate-300">Vehicle Category</span>}
                        rules={[{ required: true }]}
                      >
                    ...
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item name="make" label={<span className="text-slate-300">Make (Brand)</span>} rules={[{ required: true, message: 'Make is required' }]}>
                        <Input placeholder="e.g. Yamaha, Honda, Suzuki" />
                      </Form.Item>
                    </Col>
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item name="model" label={<span className="text-slate-300">Model</span>} rules={[{ required: true, message: 'Model is required' }]}>
                    ...
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item
                        ...
                        label={<span className="text-slate-300">Year of Manufacture</span>}
                        rules={[{ required: true }]}
                        initialValue={2023}
                      >
                    ...
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item name="estimatedMarketValue" label={<span className="text-slate-300">Total Vehicle Value (LKR)</span>} rules={[{ required: true }]}>
                        <InputNumber
                          className="w-full"
                          min={100000}
                          formatter={(value) => `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                    ...
                    <Col xs={24} sm={12} md={8}>
                      <Form.Item name="downPaymentAmount" label={<span className="text-slate-300">Customer Down Payment (LKR)</span>}>
                        <InputNumber
                          className="w-full"
                          min={0}
                          formatter={(value) => `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                    ...
                    <Col xs={24} sm={12} md={12}>
                      <Form.Item name="registrationNumber" label={<span className="text-slate-300">Registration # (If registered)</span>}>
                        <Input placeholder="e.g. WP BHY-4820 or UNREGISTERED" />
                      </Form.Item>
                    </Col>
                    <Col xs={24} sm={12} md={12}>
                      <Form.Item name="dealerName" label={<span className="text-slate-300">Dealer / Seller Name</span>}>
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-lg font-semibold text-white m-0">Guarantor Information</h3>
                <p className="text-xs text-slate-400 m-0">Minimum 1 guarantor required (up to 3 maximum)</p>
              </div>
              {guarantors.length < 3 && (
                <Button
                  type="dashed"
                  ...
                  className="border-slate-700 text-blue-400 hover:border-blue-500"
                >
            ...
            <Row gutter={[16, 16]}>
              {guarantors.map((g, idx) => (
                <Col xs={24} md={12} key={idx}>
                  <Card className="bg-slate-900/80 border-slate-800 rounded-2xl relative shadow-lg">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          <h4 className="text-white font-semibold text-sm m-0">{g.fullName || 'Primary Guarantor'}</h4>
                    ...
                    <div className="space-y-2 text-xs text-slate-300 pt-2 border-t border-slate-800">
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono font-medium text-slate-200">{g.nic}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Contact Phone:</span>
                        <span className="font-mono text-slate-200">{g.phone}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-slate-400">Occupation / Employer:</span>
                        <span className="text-slate-200 truncate max-w-[180px]">{g.occupation} ({g.employerName})</span>
                      </div>
                      <div className="flex justify-between">
            ...
            <Modal
              title={<span className="text-white">Add Loan Guarantor</span>}
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-lg font-semibold text-white m-0">Document Vault</h3>
                <p className="text-xs text-slate-400 m-0">Upload clear scanned copies or photos (PDF, PNG, JPG under 5MB)</p>
              </div>
              ...
              {requiredDocList.map((doc) => {
                ...
                return (
                  <Col xs={24} md={12} key={doc.type}>
                    <Card className="bg-slate-900/80 border-slate-800 rounded-2xl h-full flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start mb-2">
                          <span className="font-semibold text-sm text-slate-200 flex items-center gap-1.5">
                            <Paperclip className="w-4 h-4 text-blue-400" /> {doc.label}
                          </span>
                          {file ? (
                        ...
                        <p className="text-xs text-slate-400 mb-4">{doc.description}</p>
                      </div>

                      {file ? (
                        <div className="flex items-center justify-between p-3 rounded-xl bg-slate-800/80 border border-slate-700">
                          <div className="truncate max-w-[220px]">
                            <p className="text-xs font-medium text-white truncate m-0">{file.name}</p>
                        ...
                        >
                          <Button icon={<UploadCloud className="w-4 h-4" />} block className="border-dashed border-slate-700 hover:border-blue-500">
                            Select File
                          </Button>
                        </Upload>
                      )}
        ...
        {currentStep === 4 && !submittedApp && (
          <div className="space-y-6">
            <Card className="bg-slate-900/90 border-slate-800 rounded-2xl shadow-xl">
              <h3 className="text-lg font-semibold text-white mb-4">Application Review & Declaration</h3>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/60">
                  <span className="text-xs text-slate-400 uppercase font-semibold">Facility Type</span>
                  <p className="text-base font-bold text-white mt-1">
                    {facilityType === 'LOAN' ? 'Money Loan' : 'Vehicle Leasing'}
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/60">
                  <span className="text-xs text-slate-400 uppercase font-semibold">Requested Financing</span>
                  <p className="text-base font-bold text-blue-400 font-mono mt-1">
                    LKR {Number(amount).toLocaleString()}
                  </p>
                </div>
                <div className="p-4 rounded-xl bg-slate-800/60 border border-slate-700/60">
                  <span className="text-xs text-slate-400 uppercase font-semibold">Repayment Term</span>
              ...
              <div className="space-y-3 text-xs text-slate-300">
                <div className="flex justify-between">
                  <span className="text-slate-400">Guarantors Count:</span>
                  <span className="font-semibold text-slate-200">{guarantors.length} Provided</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Attached Documents:</span>
                  <span className="font-semibold text-slate-200">{Object.keys(uploadedFiles).length} Files Staged</span>
                </div>
              </div>

              <div className="mt-6 p-4 rounded-xl bg-slate-950/80 border border-slate-800 text-xs text-slate-400 leading-relaxed">
        ...
        {submittedApp && (
          <Card className="bg-slate-900/90 border-slate-800 rounded-2xl text-center py-8">
            <Result
              status="success"
              title={<span className="text-white text-2xl font-bold">Application Successfully Lodged!</span>}
              subTitle={
