...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" className="py-20 lg:py-28 bg-slate-900/60 border-t border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto relative">
          <div className="relative rounded-3xl bg-slate-950 border border-slate-800 p-8 sm:p-12 shadow-2xl">
            ...
            {/* Quote body */}
            <blockquote className="text-lg sm:text-xl text-slate-200 font-medium leading-relaxed italic mb-8">
              "{current.quote}"
            </blockquote>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-slate-800/80">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-base font-bold text-white m-0">{current.name}</h4>
                  <p className="text-xs text-slate-400 m-0">
                    {current.role} &bull; <span className="text-blue-400">{current.location}</span>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2.5 rounded-xl bg-slate-900 border border-slate-700/80 hover:border-blue-500 text-slate-300 hover:text-white transition-all cursor-pointer"
