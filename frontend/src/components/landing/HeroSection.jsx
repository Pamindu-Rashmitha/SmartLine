...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative pt-12 pb-24 lg:pt-20 lg:pb-32 overflow-hidden bg-slate-950">
      {/* Background radial glow accents */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-b from-blue-600/15 via-indigo-600/5 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 pt-6 border-t border-slate-800/80 text-left">
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span className="text-xs text-slate-300 font-medium">No Hidden Fees</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
              ...
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span className="text-xs text-slate-300 font-medium">On-Site Field Inspection</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span className="text-xs text-slate-300 font-medium">Real-Time SMS Alerts</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span className="text-xs text-slate-300 font-medium">LKR 50K – 2.5M Limit</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
                <span className="text-xs text-slate-300 font-medium">Dedicated Officer Support</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            {!showInquiry ? (
              <div className="relative mx-auto max-w-md rounded-2xl bg-slate-900/80 backdrop-blur-xl border border-slate-800 shadow-2xl p-8 text-center transition-all hover:border-blue-500/40">
                {/* Floating % button */}
                <button
                  type="button"
                  onClick={() => setShowInquiry(true)}
                  className="group inline-flex flex-col items-center justify-center p-6 rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-blue-500/30 hover:border-blue-500 shadow-xl shadow-blue-950/40 hover:shadow-blue-600/30 transition-all cursor-pointer w-full"
                ...
                >
                  ...
                  <div className="mt-5 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-600/10 border border-blue-500/20 text-blue-400 text-xs font-semibold group-hover:bg-blue-600 group-hover:text-white transition-all">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6 pt-6 border-t border-slate-800 text-left">
                  <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80">
                    ...
                    <span className="text-xs font-semibold text-emerald-400">From 14.0% p.a.</span>
                  </div>
                  <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800/80">
                    <span className="text-[10px] uppercase font-bold text-slate-500 block">Vehicle Leases</span>
                    <span className="text-xs font-semibold text-sky-400">From 12.5% p.a.</span>
                  </div>
                </div>
              </div>
            ) : (
              <div className="relative mx-auto max-w-md rounded-2xl bg-slate-900/90 backdrop-blur-xl border border-blue-500/40 shadow-2xl shadow-blue-950/40 p-6 sm:p-8 animate-fadeIn">
                {/* Card Header */}
                <div className="flex items-center justify-between pb-5 border-b border-slate-800">
                  <div>
                    <h3 className="text-lg font-bold text-white m-0">Quick Facility Inquiry</h3>
                    <p className="text-xs text-slate-400 mt-1 m-0">Instant rate & tenure estimation</p>
                  </div>
                  <button
                    type="button"
                    onClick={() => setShowInquiry(false)}
                    className="p-2.5 rounded-xl bg-blue-600/20 hover:bg-blue-600 text-blue-400 hover:text-white border border-blue-500/30 transition-all cursor-pointer flex items-center gap-1.5"
                ...
                <form onSubmit={handleQuickApply} className="mt-6 space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-blue-500"
                    >
                  ...
                  <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800/80 space-y-2">
                    ...
                    <div className="flex justify-between items-center text-[11px] text-slate-500">
                      ...
                      <span className="text-slate-300 font-medium">14.0% p.a.</span>
                    </div>
                  </div>
